...
@interface MessageTeacher()<UITableViewDelegate,UITableViewDataSource>
{
    int mark;
}
...
-(void)dateUrl:(int)marks Key:(BOOL)key
{
    ...
    NSString *date = [NSString stringWithFormat:@"%@%d",DATE_SEARCH_MESSAGE_TEACHER,marks];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.images setImageWithURL:[NSURL URLWithString:[dic objectForKey:@"field_teacher_aboutimg"]]
