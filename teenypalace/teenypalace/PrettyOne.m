...
@interface PrettyOne()<UITableViewDelegate,UITableViewDataSource>
{
    int mark;
}
...
-(void)dateUrl:(int)marks Key:(BOOL)key
{
    ...
    NSString *date = [NSString stringWithFormat:@"%@1&page=%d",DATE_PRETTY_TRENDS,marks];
