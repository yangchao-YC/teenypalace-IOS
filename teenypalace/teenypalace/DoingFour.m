...
@interface DoingFour()<UITableViewDelegate,UITableViewDataSource>
{
    int mark;
}
...
-(void)dateUrl:(int)marks Key:(BOOL)key
{
    ...
    NSString *date = [NSString stringWithFormat:@"%@%d/pager/10",DATE_SEARCH_DOING_BOOK,marks];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.titleLabel.text = [dic objectForKey:@"booktitle"];
    ...
    [cell.images setImageWithURL:[NSURL URLWithString:[dic objectForKey:@"bookthumb"]]
